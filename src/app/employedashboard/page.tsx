  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex flex-col items-center p-6">
      <header className="w-full flex justify-between items-center py-6 px-10 bg-black/40 border-b border-gray-700">
        <div>
          <h1 className="text-3xl text-white tracking-wide">Employee Dashboard</h1>
          <p className="text-gray-400">View and manage your tasks</p>
        </div>
        <Button
          className="bg-white/10 text-white hover:bg-white/20 border border-transparent hover:border-white transition-all duration-500"
